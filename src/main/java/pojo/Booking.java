...
public class Booking {
    ...
    public Booking() {
        this.firstname = TestData.getFirstName();
        this.lastname = TestData.getLastName();
        this.totalprice = TestData.getPrice(1, 9999);
        this.depositpaid = TestData.getRandomBoolEan();
        this.bookingdates = new BookingDates();
        this.additionalneeds = TestData.getRandomNeeds();
    }
